namespace GleyTrafficSystem
{
    public static class WaypointEvents
    {
        ...
        public delegate void StopIndicatorChanged(int waypointIndex);
        public static event StopIndicatorChanged onStopIndicatorChanged;
        public static void TriggerStopIndicatorChangedEvent(int waypointIndex)
        {
            if (onStopIndicatorChanged != null)
            {
                onStopIndicatorChanged(waypointIndex);
            }
        }
